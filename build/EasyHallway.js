...
export default class EasyHallway extends Room {
    ...
    constructor(canvas, mainHallway, player) {
        ...
        this.insertHitbox(65, 308.5, 30, 300);
        this.insertHitbox(959, 451.5, 50, 40);
        this.insertHitbox(144, 490.5, 97, 10);
        this.insertHitbox(383, 490.5, 145.5, 10);
        this.insertHitbox(669, 490.5, 194, 10);
